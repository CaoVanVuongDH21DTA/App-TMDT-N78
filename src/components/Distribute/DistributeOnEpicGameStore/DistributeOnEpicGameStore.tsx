...
import '../../../styles/Distribute/DistributeOnEpicGameStore.css'
                ...
                <span className="span-4">
                    <div className="container">
                        ...
                        <div className="right-container-span-4">
                            <div className="content">
                                <div className="img-span-4">
                                    <img src="https://cdn2.unrealengine.com/now-on-epic-publish-page-image-8a1e648c45e8.svg"/>
                                </div>
                                <div className="title">
                                    <span className="text">
                ...
                <span className="span-6">
                    <div className="container">
                        ...
                        <div className="bg-content">
                            <div className="content">
                                <div className="left-content">
                                    <img src="https://cdn2.unrealengine.com/epic-online-services-2023-fa8f84319372.svg"/>
                                </div>
                                <div className="right-content">
                                    <div className="title">
                                        <span className="subtitle">
                                ...
                                <div className="question">
                                    ...
                                    {isQuestion1 && (
                                        <div className="asked-question">
                                            <div className="asked">
                                                The Epic Games Store has a global audience of over 230M+ users, a 88%/12% revenue split and additional no-cost services to help bring your game to market.
                                                For games built on Unreal Engine, engine royalty fees are waived for in-store purchases using Epic's payment processor.
                                                In-app purchases and products using their own payment processor are not exempt from engine royalties.
                                            </div>
                                        </div>
                                    )}
                                </div>
                                    ...
                                    {isQuestion2 && (
                                        <div className="asked-question">
                                            <div className="asked">
                                                ...
                                                Epic is aiming to bring great games to players, regardless of your engine choice.
                                            </div>
                                        </div>
                                    )}
                                </div>
                                    ...
                                    {isQuestion3 && (
                                        <div className="asked-question">
                                            <div className="asked">
                                                ...
                                                used by developers to set up their game pages, pricing, offers, builds, and updates on the Epic Games Store.
                                            </div>
                                        </div>
                                    )}
                                </div>
                            ...
                            <li className="item-question">
                                <div className="question">
                                    ...
                                    {isQuestion4 && (
                                        <div className="asked-question">
                                            <div className="asked">
                                                The Developer Portal is the central hub to distribute games on the Epic Games Store and enhance games with Epic Online Services.
                                                The Developer Portal is used to update product information, configure back-end services, support players, and view game financial data, usage reports,
                            ...
                            <li className="item-question">
                                <div className="question">
                                    ...
                                    {isQuestion5 && (
                                        <div className="asked-question">
                                            <div className="asked">
                                                "Epic offers an ecosystem of tools, services, and communities to help anyone create, power, and distribute software.
                                                With a single Epic Games account, anyone can create with Unreal Engine, enhance with Epic Online Services and Kids Web Services, and distribute PC games on the Epic Games Store.
                                                Even more tools like Twinmotion, MetaHuman, Quixel, and Capturing Reality bring your project to the next level.
                                                And the Epic Developer Community is here to connect creators alike to share and learn. Learn more about
                                    ...
                                    {isQuestion6 && (
                                        <div className="asked-question">
                                            <div className="asked">
                                                ...
                                                <FaArrowUpRightFromSquare className="icon-show-question"/>
                                                . From there the sign up wizard will help guide registration of your company and the build of your first game.
                                                Be sure to have business information (contact info and tax/payout information) on hand.
                                                Important to note there is a recoupable $100 USD submission fee per game which will need to paid before releasing on the store. Read our
                            ...
                            <li className="item-question">
                                <div className="question">
                                    ...
                                    {isQuestion7 && (
                                        <div className="asked-question">
                                            <div className="asked">
                                                All products published on the Epic Games Store adhere to our content guidelines.
                                                In addition, they must launch, run, and be consistent with the product description presented to users via their Product Details Page (PDP).
                                            </div>
                                            <div className="asked">
                                                Multiplayer games must support crossplay across all PC stores. This is to make sure players who purchase
                                                a multiplayer game on any store can easily connect with other players, regardless of where the game was purchased.
                                                To achieve this, you can implement crossplay yourself, use a third-party SDK, or use Epic Online Services for free.
                                            </div>
                                            <div className="asked">
                                                Achievements - All games onboarded to the Epic Games Store publishing tools after March 9, 2023
                                                are required to enable Epic Games Store achievements if the game has achievements on other PC stores.
                                                This helps standardize the player experience regardless of where the game was purchased.
                                            </div>
                                            <div className="asked">
                                                Visit the
                            ...
                            <li className="item-question">
                                <div className="question">
                                    ...
                                    {isQuestion8 && (
                                        <div className="asked-question">
                                            <div className="asked">
                                                Products that contain prohibited content (hateful or discriminatory content, pornography, and illegal content)
                                                are not eligible for distribution on the Epic Games Store. Content that infringes on intellectual property
                                                you do not own or have rights to use scams, frauds, or deceptive practices, such as fake games
                                                or malware are also prohibited. Published products receiving complaints about content that does not meet the
                                                criteria may be subject to re-review and removal from the Epic Games Store. Visit the
                                                <a href="#">Epic Games Store Ratings & Content Guidelines documentation</a>
                                                <FaArrowUpRightFromSquare className="icon-show-question"/>
                                                 for more information.
                                            </div>
                                        </div>
                            ...
                            <li className="item-question">
                                <div className="question">
                                    ...
                                    {isQuestion9 && (
                                        <div className="asked-question">
                                            <div className="asked">
                                                Yes, we do support regional pricing. We also have a set of suggested regional discounts based on local norms.
                                            </div>
                                        </div>
                                    )}
                                </div>
                            ...
                            <li className="item-question">
                                <div className="question">
                                    <button className="btn-show-question" onClick={toggleQuestion10}>
                                        ...
                                        <span className="icon-btn-add">
                                            {isQuestion10 ? <IoMdRemove className="icon" /> : <IoMdAdd className="icon" />}
                                        </span>
                                    </button>
                                    {isQuestion10 && (
                                        <div className="asked-question">
                                            <div className="asked">
                                                Games and products purchased through the Epic Games Store are generally eligible for a refund.
                                                These products are marked “refundable”.  If a game or product is marked as "non-refundable",
                                                then it is not eligible for a refund. Products that include virtual currency
                                                or other consumables are marked “non-refundable” and are not eligible for refund.
                                                Also, most in-app purchases are non-refundable. Epic cannot provide refunds for purchases
