...
import technical_accounts from "../../img/Support/technical_accounts.jpg";
import parent_accounts from "../../img/Support/parent_accounts.jpg";
...
import kida_games from "../../img/Support/kida_games.jpg";
import shadow_games from "../../img/Support/shadow_games.jpg";
import postparty_games from "../../img/Support/postparty_games.jpg";
...
// =================================================== Giao dien ==========================================
    return (
        <main className="mid">
            ...
            <Routes>
                <Route path="Support" element={<Mid/>}/>
